...
[![GZip size](https://img.badgesize.io/substrate-system/button/main/dist/index.js?compression=gzip&label=gzip&style=flat-square)](https://esm.sh/@substrate-system/button/es2022/button.mjs)
